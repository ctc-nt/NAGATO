...
def test_show_ip():
    ...
    print(f"\n{output=}")
    assert output == [["B", "110.1.0.0/24", "10.1.110.100"], ["B", "110.1.1.0/24", "10.1.110.100"], ["B", "110.1.2.0/24", "10.1.110.100"], ["B", "110.1.3.0/24", "10.1.110.100"], ["B", "110.1.4.0/24", "10.1.110.100"], ["B", "110.1.5.0/24", "10.1.110.100"]]
