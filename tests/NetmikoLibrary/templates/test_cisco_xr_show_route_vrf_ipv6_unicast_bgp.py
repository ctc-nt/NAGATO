...
def test_show_ip():
    ...
    print(f"\n{output=}")
    assert output == [
        ["B", "110:1::/64", "fe80::211:1ff:fe00:1"],
        ["B", "110:1:1::/64", "fe80::211:1ff:fe00:1"],
        ["B", "110:1:2::/64", "fe80::211:1ff:fe00:1"],
        ["B", "110:1:3::/64", "fe80::211:1ff:fe00:1"],
        ["B", "110:1:4::/64", "fe80::211:1ff:fe00:1"],
        ["B", "110:1:5::/64", "fe80::211:1ff:fe00:1"],
    ]
