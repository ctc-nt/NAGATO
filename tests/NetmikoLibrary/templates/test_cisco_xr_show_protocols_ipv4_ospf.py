...
def test_show_ip():
    ...
    assert output == [["OSPF 1", "55.55.55.55", "110", "Enabled", "0", ["GigabitEthernet 0/3/0/3", "Loopback0"]], ["OSPF 1", "55.55.55.55", "110", "Enabled", "1", ["Loopback1"]], ["OSPF 2", "3.3.3.3", "110", "Disabled", "0", ["Loopback3"]]]
