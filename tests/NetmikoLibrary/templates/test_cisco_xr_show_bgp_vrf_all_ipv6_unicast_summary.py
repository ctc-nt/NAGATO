...
def test_show_ip():
    ...
    print(f"\n{output=}")
    assert output == [['Test_01', 'Active', '10:1:110::100', '0', '110', '106', '8', '603', '0', '0', '100'], ['Test_01', 'Active', '10:2:110::100', '0', '210', '106', '8', '603', '0', '0', '100'], ['Test_02', 'Active', '10:1:120::100', '0', '120', '107', '8', '603', '0', '0', '100'], ['Test_02', 'Active', '10:2:120::100', '0', '220', '107', '8', '603', '0', '0', '100']]
